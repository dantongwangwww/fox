  ...
  <div class="main">
    <div :class="['tree-box', { 'collapsed': isTreeCollapsed }]">
      ...
      <el-scrollbar height="100%">
        <el-tree style="max-width: 600px" :data="tableData" :props="defaultProps" :default-expand-all="true"
...
function init(node) {
  ...
  newCtrl.apiUrl = notifyUrl.value;
...
function closeMap(callback) {
  return axios
    .post(`${notifyUrl.value}/api/doublefoxapp/${oldMap.value.port}/MapServices/close`, {
...
function getGdfList(page, limit,) {
  return axios
    .post(`${notifyUrl.value}/api/doublefoxapp/serverproxy/graphicservices/allfilelist`)
    .then((res) => {
